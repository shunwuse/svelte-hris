...
export type ActionableApprovalStatus = Exclude<
  ApprovalStatus,
  typeof APPROVAL_STATUS.PENDING
>;
...
export function isApprovalStatus(value: unknown): value is ApprovalStatus {
  return (
    typeof value === 'string' &&
    Object.values(APPROVAL_STATUS).includes(value as ApprovalStatus)
  );
}

export function isActionableApprovalStatus(
  value: unknown,
): value is ActionableApprovalStatus {
  return (
    value === APPROVAL_STATUS.APPROVED || value === APPROVAL_STATUS.REJECTED
  );
}
